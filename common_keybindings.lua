...
local common_vim_keybindings = {
	...
	-- Square bracket commands
	{
		mode = "Normal",
		lhs = "[<C-D>",
		desc = "Jump to first #define in current and included files, matching the word under the cursor, starting from the beginning of the current file",
	},
	{
		mode = "Normal",
		lhs = "[<C-I>",
		desc = "Jump to first line in current and included files that contains the word under the cursor, starting from the beginning of the current file",
	},
	...
	{ mode = "Normal", lhs = "[/", desc = "Cursor to N previous start of a C comment" },
	{
		mode = "Normal",
		lhs = "[D",
		desc = "List all #defines in current and included files matching the word under the cursor, starting from the beginning of the current file",
	},
	{
		mode = "Normal",
		lhs = "[I",
		desc = "List all lines in current and included files that contain the word under the cursor, starting from the beginning of the current file",
	},
	...
	{ mode = "Normal", lhs = "[c", desc = "Cursor N times backwards to start of change" },
	{
		mode = "Normal",
		lhs = "[d",
		desc = "Show first #define found in current and included files matching the word under the cursor, starting from the beginning of the current file",
	},
	{ mode = "Normal", lhs = "[f", desc = 'Same as "gf"' },
	{
		mode = "Normal",
		lhs = "[i",
		desc = "Show first line found in current and included files that contains the word under the cursor, starting from the beginning of the current file",
	},
	...
	{ mode = "Normal", lhs = "[<MiddleMouse>", desc = 'Same as "[p"' },
	{
		mode = "Normal",
		lhs = "]<C-D>",
		desc = "Jump to first #define in current and included files, matching the word under the cursor, starting from cursor position",
	},
	{
		mode = "Normal",
		lhs = "]<C-I>",
		desc = "Jump to first line in current and included files that contains the word under the cursor, starting from cursor position",
	},
	...
	{ mode = "Normal", lhs = "]/", desc = "Cursor to N next end of a C comment" },
	{
		mode = "Normal",
		lhs = "]D",
		desc = "List all #defines in current and included files matching the word under the cursor, starting from cursor position",
	},
	{
		mode = "Normal",
		lhs = "]I",
		desc = "List all lines in current and included files that contain the word under the cursor, starting from cursor position",
	},
	{ mode = "Normal", lhs = "]P", desc = 'Same as "[p"' },
	...
	{ mode = "Normal", lhs = "]c", desc = "Cursor N times forward to start of change" },
	{
		mode = "Normal",
		lhs = "]d",
		desc = "Show first #define found in current and included files matching the word under the cursor, starting from cursor position",
	},
	{ mode = "Normal", lhs = "]f", desc = 'Same as "gf"' },
	{
		mode = "Normal",
		lhs = "]i",
		desc = "Show first line found in current and included files that contains the word under the cursor, starting from cursor position",
	},
	...
	{ mode = "Visual", lhs = "i[", desc = "Extend highlighted area with inner [] block" },
	{
		mode = "Visual",
		lhs = "i`",
		desc = "Extend highlighted area with backtick quoted string (without the backticks)",
	},
	...
	{ mode = "Command-line", lhs = "<C-U>", desc = "Remove all characters" },
	{
		mode = "Command-line",
		lhs = "<C-V>",
		desc = "Insert next non-digit literally, insert three-digit decimal as a single byte",
	},
	...
	-- Terminal mode
	{
		mode = "Terminal",
		lhs = "<C-\\>",
		desc = "Escape sequence, the next key is forwarded unless it's <C-N> or <C-O>",
	},
